...
- [`foodlens-video-demo-refined-2026-06-02.png`](2026-06-02/foodlens-video-demo-refined-2026-06-02.png) - Video demo refinement pass using the bundled burger-making sample, captured at `1440x1013`, with a balanced four-region crop grid, frame labels, fallback status styling, and the strongest hamburger crop selected by default.
- [`foodlens-video-demo-timestamp-polish-2026-06-02.png`](2026-06-02/foodlens-video-demo-timestamp-polish-2026-06-02.png) - Video demo timestamp polish pass using the bundled burger-making sample, captured at `1440x1100`, with portrait video playback, sampled frame region labels, frame timestamps, and simplified video aggregation metadata.
- [`foodlens-video-compact-crops-2026-06-02.png`](2026-06-02/foodlens-video-compact-crops-2026-06-02.png) - Compact sampled-frame crop review pass for the bundled burger-making sample, captured at `1440x1100`, with shorter video crop cards and separated video aggregation metadata details.
- [`foodlens-source-context-image-2026-06-02.png`](2026-06-02/foodlens-source-context-image-2026-06-02.png) - Source context polish pass for the analyzed West Kitchen image state, captured at `1440x1100`, with the submitted source host retained as a compact control chip.
- [`foodlens-video-frame-review-chip-2026-06-02.png`](2026-06-02/foodlens-video-frame-review-chip-2026-06-02.png) - Video fallback wording polish pass for the bundled burger-making sample, captured at `1440x1100`, with fallback sampled frames labeled as frame-level review.
